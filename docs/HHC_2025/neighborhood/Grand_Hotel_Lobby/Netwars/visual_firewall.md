...
solution - tick https, http and ssh
...
solution, tick every box

![alt text](/docs/HHC_2025/neighborhood/Grand_Hotel_Lobby/netwars/fw_workstations.png)

## Game Location

![alt text](/docs/HHC_2025/neighborhood/Grand_Hotel_Lobby/Netwars/visual_firewall.png)
